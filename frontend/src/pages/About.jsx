    ...
    <div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <h2 className="text-center font-heading text-5xl font-bold text-[#77B81E] mb-12">A Little Story About Us</h2>
          <div className="flex flex-col md:flex-row gap-12 items-start">
            ...
            <div className="md:w-1/2 space-y-5 text-gray-700 text-md leading-relaxed">
              <p>
